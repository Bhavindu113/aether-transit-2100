        ...
        {SLIDES.map((slide, idx) => {
          ...
          return (
            ...
            >
              ...
              <div className="absolute bottom-3 left-3 right-3 sm:bottom-6 sm:left-6 sm:right-auto sm:max-w-md z-20">
                <div className="p-3 sm:p-5 rounded-xl sm:rounded-2xl bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border border-slate-200/90 dark:border-slate-700 shadow-lg">
                  <div className="flex items-center space-x-2 mb-1">
                    <span className="inline-flex items-center gap-1.5 text-[10px] sm:text-[11px] font-semibold px-2 py-0.5 sm:px-2.5 rounded-full bg-blue-50 dark:bg-blue-950/70 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-800">
                  ...
                  {/* Main Name Only on Mobile; Full Description on Larger Screens */}
                  <h3 className="text-sm sm:text-lg font-bold text-slate-900 dark:text-white tracking-tight">
                    {slide.title}
                  </h3>
                  <p className="hidden sm:block text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed font-normal mt-1">
                    {slide.subtitle}
                  </p>
                </div>
              </div>
